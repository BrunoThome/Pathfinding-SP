/**
  ...
  sigma.classes.graph.addMethod('printPath', function(path) {
        pathList = [],

    pathList = path.map((node) => node.id)
  ...
  function addClickNode(s){
    s.bind('clickNode', function(e) {
        ...
        switch (option){
            case 'inicio':
                start_node = e.data.node.id;
                break;
            case 'fim':
                end_node = e.data.node.id;
                break;
            default:
                break;
        }
    ...
    function showPath(s){
      ...
      s.graph.edges().forEach(function(e) {
        ...
        var path = s.graph.astar(start_node, end_node);
            toKeep = s.graph.printPath(path);
